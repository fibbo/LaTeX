...
\usepackage[slc=off]{caption} %für subfloats
...
\begin{figure}[h]
\centering
  \captionbox{Source: Internet}{\includegraphics[width=0.5\textwidth]{gull_picture}Source: Web}
\end{figure}

\begin{figure}[h]
  \centering
      \includegraphics[width=0.5\textwidth]{pics/gull_picture}\par %bild nicht im gleichen ordner wie das LaTeX Dokument
      Source: Internet
...
\begin{figure}[h]
\begin{threeparttable} %p erzielt, dass die figure auf einer Seite speziell für floats platziert wird
